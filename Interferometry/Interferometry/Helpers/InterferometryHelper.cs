...
namespace Interferometry.Helpers {
    public class InterferometryHelper {
        ...
        public static RealMatrix[] GetLinearInterferograms(
            ...
            InterferogramInfo interferogramInfo = new InterferogramInfo( width, height, noisePercent, minIntensity, null, null );
        ...
        public static RealMatrix[] GetCircleInterferograms(
            ...
            InterferogramInfo interferogramInfo = new InterferogramInfo( width, height, minIntensity, noisePercent, null, null );
